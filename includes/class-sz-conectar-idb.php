...
class Sz_Conectar_Idb {
	 ...
	 *
	 * - Sz_Conectar_Idb_Loader. Orchestrates the hooks of the plugin.
	 * - Sz_Conectar_Idb_i18n. Defines internationalization functionality.
	 * - Sz_Conectar_Idb_Admin. Defines all hooks for the admin area.
	 * - Sz_Conectar_Idb_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Sz_Conectar_Idb_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Sz_Conectar_Idb_Loader    Orchestrates the hooks of the plugin.
	 */
